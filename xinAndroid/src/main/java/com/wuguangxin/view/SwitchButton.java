...
//	public static final int DEFAULT_TINT_COLOR = 0x327FC2;
	public static final int DEFAULT_TINT_COLOR = 0xFFee2f3a;
...
//		setThumbDrawable(getDrawable(getContext(), thumbDrawableRes));
...
//		setBackDrawable(ContextCompat.getDrawable(getContext(), backDrawableRes));
	...
	public void setBackColorRes(int backColorRes) {
		//setBackColor(ContextCompat.ColorStateList(getContext(), backColorRes));
	}
