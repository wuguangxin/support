    ...
    private void doTouchEvent(MotionEvent event) {
        ...
        switch (action) {
            case MotionEvent.ACTION_MOVE:
                Logger.e("doTouchEvent", "ACTION_MOVE");
                doActionMove(event);
                break;

            case MotionEvent.ACTION_UP:
                Logger.e("doTouchEvent", "ACTION_UP");
...
//        if (deltaY * 0.5f * SCROLL_RATIO > getResources().getDimension(R.dimen.base_dimen_130)) {
        if (deltaY * 0.5f * SCROLL_RATIO > getResources().getDimension(R.dimen.font_50)) {
        ...
        Logger.e("doTouchEvent", "deltaY = " + deltaY);
        if (isMoving) {
            Logger.e("doTouchEvent", "isMoving");
            // 初始化content view矩形
            ...
            if (top <= headerBottom) {
                Logger.e("doTouchEvent", "mContentView.layout");
                // 移动content view
