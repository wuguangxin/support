...
public class BannerViewPager extends ViewPager {
    ...
    public static final int        DEFAULT_INTERVAL            = 1500; // 首次滚动延时
    ...
    private static class MyHandler extends Handler {
        ...
        public MyHandler(BannerViewPager autoScrollViewPager) {
            this.bannerViewPager = new WeakReference<>(autoScrollViewPager);
        }
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case SCROLL_WHAT:
                    BannerViewPager pager = this.bannerViewPager.get();
                    if (pager != null) {
