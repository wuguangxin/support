...
public class RefreshScrollView extends ScrollView {
	...
	/** 布局移动多大距离才回调onRefresh()方法（单位dip） */
	private static final float REFRESH_FACTOR = 70;
	...
	public boolean dispatchTouchEvent(MotionEvent ev){
		if (contentView == null || mode == Mode.DISABLED) {
...
//			return;
//		}
		if ((upY - downY) * MOVE_FACTOR > REFRESH_FACTOR) {
