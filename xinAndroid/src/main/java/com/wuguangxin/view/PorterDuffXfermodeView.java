...
public class PorterDuffXfermodeView extends View{
	...
	public PorterDuffXfermodeView(Context context, AttributeSet attrs){
		...
		mSpeed = Utils.dip2px(context, WAVE_TRANS_SPEED);
...
//		mSrcBitmap = ((BitmapDrawable) context.getResources().getDrawable(R.drawable.wave_2000)).getBitmap();
//		mMaskBitmap = ((BitmapDrawable) context.getResources().getDrawable(R.drawable.circle_500)).getBitmap();
	}
