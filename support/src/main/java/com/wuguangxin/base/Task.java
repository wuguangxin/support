...
public abstract class Task<T> {
     ...
     */
    public abstract void inTask(T task);

    /**
     * 出栈
     * @param task 出栈的 Activity/Fragment
     */
    public abstract void outTask(T task);
...
//	public void backTask(Class taskClass);
     ...
     * @return 列表
     */
    public abstract LinkedList<T> getTaskList();
    ...
    public void printTaskInfo(String tag, String className, String msg) {
        String taskTop = "null";
        int taskSize = 0;
        if (taskList != null) {
