...
//		keyParams = new LinearLayout.LayoutParams(Utils.dip2px(context, 100), LayoutParams.WRAP_CONTENT);
		keyParams = new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
		valueParams = new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT);
