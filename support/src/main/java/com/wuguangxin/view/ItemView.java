...
public class ItemView extends LinearLayout {
    ...
    // key-margin
    private int keyMargin = -1;     // keyView 的 margin，当 keyMargin >= 0 时，左上右下的值等于 keyMargin
    private int keyMarginTop;       // keyView 的 marginTop
    private int keyMarginLeft;      // keyView 的 marginLeft
    private int keyMarginRight;     // keyView 的 marginRight
    private int keyMarginBottom;    // keyView 的 marginBottom
    // key-padding
    private int keyPadding = -1;    // keyView 的 Padding，当 keyPadding >= 0 时，左上右下的值等于 keyPadding
    private int keyPaddingTop;      // keyView 的 PaddingTop
    private int keyPaddingLeft;     // keyView 的 PaddingLeft
    private int keyPaddingRight;    // keyView 的 PaddingRight
    private int keyPaddingBottom;   // keyView 的 PaddingBottom
    // key-drawable
    ...
    private int valueMarginTop; // valueView 的 marginTop
    private int valueMarginLeft; // valueView 的 marginLeft
    private int valueMarginRight; // valueView 的 marginRight
    private int valueMarginBottom; // valueView 的 marginBottom
    // value-padding
    private int valuePadding = -1; // 当 valuePadding >= 0 时，左上右下的值等于 valuePadding
    private int valuePaddingTop; // valueView 的 paddingTop
    private int valuePaddingLeft; // valueView 的 paddingLeft
    private int valuePaddingRight; // valueView 的 paddingRight
    private int valuePaddingBottom; // valueView 的 paddingBottom
    // value-drawable
    private int valueDrawablePadding; // valueView 的 drawablePadding
    private Drawable valueDrawableLeft; // valueView 的 drawableLeft
    private Drawable valueDrawableRight; // valueView 的 drawableRight
    private Drawable valueBackground;  // valueView 的 背景
    private GravityMode valueGravity = GravityMode.left; // valueView 的 内容对齐方式

    private int dividerTopMarginTop; // 上指示器距上 px
    private int dividerTopMarginLeft; // 上指示器距左 px
    private int dividerTopMarginRight; // 上指示器距右 px
    private int dividerBottomMarginLeft; // 下指示器距左 px
    private int dividerBottomMarginRight; // 下指示器距右 px
    private int dividerBottomMarginBottom; // 下指示器距下 px
    ...
    public ItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (keyMargin != -1) {
            keyMarginLeft = keyMarginTop = keyMarginRight = keyMarginBottom = keyMargin;
        }
        ...
        if (keyPadding != -1) {
            keyPaddingLeft = keyPaddingTop = keyPaddingRight = keyPaddingBottom = keyPadding;
        }
