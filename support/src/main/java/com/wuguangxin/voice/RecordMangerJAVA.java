...
public class RecordMangerJAVA {
     ...
     * @param savePath 保存目录
     */
    public RecordMangerJAVA(Context context, File savePath) {
     ...
     */
    public RecordMangerJAVA(Context context, File savePath, OnRecordListener onRecordListener) {
